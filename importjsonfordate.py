...
modelingfile = input("Enter your the name of the modeling file to create:")

firstdate = input("Enter the date (ie 2016-11-25):")
...
appenddate = input ("Enter the date to add to your data set (ie 2016-11-25):")
sensorname_web = urllib.request.urlopen('https://dweet.io/get/stored/dweets/for/'+sensorname+'?key='+dweetkey+'&date='+appenddate);
with open(modelingfile+'.json', 'r') as sensorname_file:
  sensorname_file.write(sensorname_web.read())
  time.sleep(1)
